...
export const AppConfig = {
  serviceUrls: {
    ...
    team: (id: number) => SERVICE_BASE_URL + `/teams/${id}`,
    subTeams: SERVICE_BASE_URL + "/sub-teams",
    subTeam: (id: number) => SERVICE_BASE_URL + `/sub-teams/${id}`,
    units: SERVICE_BASE_URL + "/units",
    unit: (id: number) => SERVICE_BASE_URL + `/units/${id}`,
    offices: SERVICE_BASE_URL + "/offices",
    houses: SERVICE_BASE_URL + "/houses",

    businessUnitTeams: SERVICE_BASE_URL + "/business-unit-teams",
    businessUnitTeam: (id: number) => SERVICE_BASE_URL + `/business-unit-teams/${id}`,
    businessUnitTeamSubTeams: SERVICE_BASE_URL + "/business-unit-team-sub-teams",
    businessUnitTeamSubTeam: (id: number) => SERVICE_BASE_URL + `/business-unit-team-sub-teams/${id}`,
    businessUnitTeamSubTeamUnits: SERVICE_BASE_URL + "/business-unit-team-sub-team-units",
    businessUnitTeamSubTeamUnit: (id: number) => SERVICE_BASE_URL + `/business-unit-team-sub-team-units/${id}`,
    companyOrgChartStructure: SERVICE_BASE_URL + "/company-org-structure",
  },
};
