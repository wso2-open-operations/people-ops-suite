...
# Bind values to an email template and base64-encode the result.
#
# + content - Email template string containing <!-- [KEY] --> placeholders
# + keyValPairs - Map of placeholder keys to replacement values
# + return - Base64-encoded email content or an error
