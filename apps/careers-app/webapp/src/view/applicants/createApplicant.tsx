...
const mainValidationSchema = yup.object({
  ...
  skillsText: yup
    ...
    .test(
      "not-empty",
      "Skills are required. Please add at least one skill.",
      (value) => {
  ...
  interestsText: yup
    ...
    .test(
      "not-empty",
      "Interests are required. Please add at least one interest.",
      (value) => {
        return value ? value.trim().length > 0 : false;
      }
    ),
              ...
              onSubmit={async (e) => {
                ...
                if (!resumeFile) {
                  dispatch(
                    enqueueSnackbarMessage({
                      message:
                        "Resume/CV is required. Please upload your resume.",
                      type: "error",
                    })
                  );
                  return;
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Typography sx={{ fontSize: 18 }}>
                        Yes, I give WSO2 permission to use my personal data for
