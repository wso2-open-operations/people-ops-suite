...
isolated function createapplicantProfileQuery(CreateApplicantProfile applicant) returns sql:ParameterizedQuery =>
    `INSERT INTO applicants (
        ...
        ${applicant.country}, 
        ${applicant.status},
        ${applicant.professionalLinks.toJsonString()}, 
        ${applicant.educations.toJsonString()}, 
        ${applicant.experiences.toJsonString()},
        ${applicant.skills.toJsonString()}, 
        ${applicant.certifications.toJsonString()}, 
        ${applicant.projects.toJsonString()},
        ${applicant.languages.toJsonString()}, 
        ${applicant.interests.toJsonString()},
