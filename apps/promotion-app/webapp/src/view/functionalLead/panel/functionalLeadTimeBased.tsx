...
import { EmployeeJoinedDetails } from "@slices/employeeSlice/employee";
                ...
                {promotionCycle.state === "success" && 
                 ...
                 promotions.promotions.length > 0 &&(
                    <>
                        ...
                        >
                            <Typography variant="h5">TimeBased Promotion</Typography>
                        </Box>
                        ...
                        <TableRow>
                            ...
                            <TableCell sx={{ px: 4 }}>
                                ...
                                {promotions.promotions.map((req: any) => {
                                    ...
                                    return (
                                        <TableRow key={req.id}>
                                            <TableCell sx={{ px: 4 }}>{req.employeeEmail}</TableCell>

                                            <TableCell sx={{ px: 4 }}>
                                                <Chip
                                                    label={recommendation?.promotionRequestStatus || "N/A"}
                                                    size="small"
                                                    sx={{
                                                        backgroundColor:
                                                        statusColorMap[
