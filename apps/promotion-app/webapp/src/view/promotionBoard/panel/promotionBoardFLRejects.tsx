    ...
    return (
        <>
            ...
            >
                ...
                {(promotionCycle.state === "loading" || 
                    promotions.state === "loading") && (
                    <LoadingEffect message={"Loading Functional Lead Rejected Promotions"} />
                )}
                ...
                {promotionCycle.state === "success" && 
                 ...
                 promotions.promotions.length > 0 &&(
                    <>
                        ...
                        >
                            <Typography variant="h5">Functional Lead Rejected Promotions</Typography>
                        </Box>
                ...
                {(promotionCycle.state === "failed" || 
                    ...
                    >
                        <StateWithImage
                            ...
                            message="Unable to load Functional Lead Rejected Promotions."
                        />
                    </Box>
                )}
            </Box>
