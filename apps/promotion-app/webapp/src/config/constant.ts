...
export const SnackMessage = {
    success: {
    addPromotion: "Successfully created the Promotion",
    deletePromotion: "Successfully deleted the Promotion",
  },
  error: {
    addPromotion: "Unable to create the Promotion",
    deletePromotion: "Unable to delete the Promotion",
