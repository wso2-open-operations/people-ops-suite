...
import advertisementReducer from "@slices/advertisementSlice/advertisement";
...
import foodWasteDailyReducer from "@slices/foodWasteDailySlice/foodWasteDaily";
...
export const store = configureStore({
  reducer: {
    ...
    foodWasteDaily: foodWasteDailyReducer,
