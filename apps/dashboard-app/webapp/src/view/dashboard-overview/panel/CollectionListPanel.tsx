          ...
          >
            ...
            <Box sx={{ mt: 1 }}>
              <Typography align="center" variant="h3" color={"secondary.dark"}>
                {DashboardOverviewMessage.panel.serverErrorTitle}
              </Typography>
              <Typography align="center" fontWeight={500} sx={{ mt: 2 }} variant="body1">
                {DashboardOverviewMessage.panel.serverErrorDescription}
              </Typography>
            </Box>
          </Stack>
        </Fade>
          ...
          {count === 0 && (
            <Fade in={collection.state === State.success}>
              ...
              >
                ...
                <Box>
                  <Typography align="center" variant="h4" color={"secondary.dark"}>
                    {DashboardOverviewMessage.panel.noDataTitle}
                  </Typography>
                  <Typography align="center" fontWeight={500} sx={{ mt: 2 }} variant="body2">
                    {DashboardOverviewMessage.panel.noDataDescription}
                  </Typography>
                </Box>
              </Stack>
            </Fade>
