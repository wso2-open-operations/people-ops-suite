...
const CollectionCard = ({ collection, actions, dataCardIndex }: CollectionCardProps) => {
  ...
  const resolveCollectionIcon = (key: "name" | "description" | "itemCount" | "contact") => {
  ...
  const detailCards = [
    {
      ...
      items: [
        ...
        },
        {
          title: "Items",
          subTitle:
            collectionMeta.itemCount !== undefined ? String(collectionMeta.itemCount) : "N/A",
  ...
  return (
    <Grow
      ...
      {...(dataCardIndex !== undefined ? { timeout: Math.min(dataCardIndex * 200, 1500) } : {})}
    >
      <Stack>
        <Accordion
          variant="outlined"
