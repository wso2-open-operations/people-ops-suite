...
export const themeSettings = (mode: PaletteMode) => {
  ...
  return {
    palette: {
      ...
      background: {
        default: mode === "dark" ? "#121C30" : "#EAF0F7",
        paper: mode === "dark" ? "#1E325C" : "#FFFFFF",
      },
      text: {
      ...
      surface: {
        primary: {
          active: mode === "dark" ? "#121C30" : "#EAF0F7",
          hover: mode === "dark" ? "#1E325C" : "#FFFFFF",
        },
        secondary: {
          active: "#17223A",
          hover: "#1B2A49",
    ...
    components: {
          ...
          body: {
            background:
              mode === "dark"
                ...
                : "linear-gradient(210deg, #FFFFFF 0%, #EBF2F7 60%, #C8D9E6 90%)",
            minHeight: "100vh",
          },
        },
      },
      MuiDataGrid: {
        styleOverrides: {
          root: {
            ...
            "& .MuiDataGrid-filler": { backgroundColor: "transparent", borderTop: "none" },
            "& .MuiDataGrid-scrollbarFiller": { backgroundColor: "transparent", borderTop: "none" },
            "& .MuiDataGrid-topContainer": { backgroundColor: "transparent" },
            "& .MuiDataGrid-topContainer::after": { display: "none" },
            "& .MuiDataGrid-main": { backgroundColor: "transparent" },
            "& .MuiDataGrid-withBorderColor": { borderColor: "transparent" },
            "& .MuiDataGrid-cell": { borderBottom: "none", outline: "none !important" },
            "& .MuiDataGrid-columnHeader": { borderBottom: "none" },
          },
          columnHeaders: { backgroundColor: "transparent", borderBottom: "none" },
          columnHeader: { padding: 0, backgroundColor: "transparent", borderBottom: "none" },
      ...
      MuiCard: {
        styleOverrides: {
          root: {
            backgroundColor:
              mode === "dark" ? "rgba(18, 28, 48, 0.72)" : "rgba(255, 255, 255, 0.72)",
