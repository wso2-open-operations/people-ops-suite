...
import { RequestState, SpecialRatingAllocation } from "@utils/types";
          ...
          {processedGroupedData.map((group) => {
            const top20 =
              group.top5Quota === 1 && group.top20Quota === 0
                ...
                : group.top20Quota;
            return (
              <Grid item xs={12} key={group.quotaId}>
                <Card
                  sx={{
                    height: "fit-content",
                    display: "flex",
                    ...
                    sx={{
                      ...
                      bgcolor:
                        theme.palette.mode === "light"
                          ? alpha(colors.blueAccent[100], 0.9)
                          : alpha(colors.blueAccent[500], 0.25),
